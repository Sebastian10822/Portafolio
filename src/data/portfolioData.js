...
export const projectsData = [
  ...
  },
  {
    ...
    description:
      'Aplicación web para gestión de tareas con colaboración en tiempo real, sincronización en la nube y sistema drag & drop.',
    tech: ['Vue.js', 'Firebase', 'Socket.io'],
    demo: 'https://bit.ly/laureles-brasas',
    github: 'https://github.com/',
    image: `${import.meta.env.BASE_URL}Imagenes/Laureles-Brasas.png`,
  },
  {
    title: 'Motos-store',
    description:
    ...
    image: `${import.meta.env.BASE_URL}Imagenes/Motos-store.png`,
  },
]
